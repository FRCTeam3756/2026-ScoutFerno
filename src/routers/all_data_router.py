...
async def read_all_data_by_match_route(competition: str, match_number: int, creds: Credentials = Depends(require_auth)):
...
async def read_all_data_by_team_match_route(competition: str, team_number: int, match_number: int, creds: Credentials = Depends(require_auth)):
...
async def update_all_data_by_team_match_route(competition: str, team_number: int, match_number: int, match_data: All_Data_Update, creds: Credentials = Depends(require_auth)):
