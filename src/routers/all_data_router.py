...
from ..crud.all_data_crud import read_all_data, read_all_data_by_match, read_all_data_by_team, read_all_data_by_team_match, create_all_data, delete_all_data, delete_all_data_by_match, delete_all_data_by_team, delete_all_data_by_team_match
...
async def delete_all_data_route(competition: str, team_number: int, match_number: int):
    return await delete_all_data(competition, team_number, match_number)
...
async def delete_all_data_by_team_match_route(team_number: int):
