...
async def update_interview_data_route(team_number: int, interview_data: Interview_Data_Update):
    return await update_interview_data(team_number, interview_data)


@router.delete("/interview_data/team/{team_number}")
# async def delete_interview_data_route(team_number: int, creds: Credentials = Depends(require_auth)):
async def delete_interview_data_route(team_number: int):
    return await delete_interview_data(team_number)