...
async def read_endgame_data_by_match_route(competition: str, match_number: int, creds: Credentials = Depends(require_auth)):
...
async def read_endgame_data_by_team_match_route(competition: str, team_number: int, match_number: int, creds: Credentials = Depends(require_auth)):
...
async def update_endgame_data_route(competition: str, team_number: int, match_number: int, match_data: Endgame_Data_Update, creds: Credentials = Depends(require_auth)):
