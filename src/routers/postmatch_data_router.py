...
# async def read_postmatch_data_by_match_route(match_number: int, creds: Credentials = Depends(require_auth)):
...
# async def read_postmatch_data_by_team_match_route(team_number: int, match_number: int, creds: Credentials = Depends(require_auth)):
...
# async def update_postmatch_data_route(team_number: int, match_number: int, match_data: Postmatch_Data_Update, creds: Credentials = Depends(require_auth)):
