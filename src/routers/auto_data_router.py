...
async def read_auto_data_by_match_route(match_number: int):
...
async def read_auto_data_by_team_match_route(team_number: int, match_number: int):
...
async def update_auto_data_route(team_number: int, match_number: int, match_data: Auto_Data_Update):
...
async def delete_match_auto_data_route(team_number: int, match_number: int):
